...
# Laod MAF file
```{r}
Merged_MAF <- read.maf("/Users/chenjiqing/Public/Whole Exome Sequencing/MAF_summary/merged_mafs_files_maftools.maf")
...
oncoplot(maf = Merged_MAF, showTumorSampleBarcodes = T, SampleNamefontSize = 1, fontSize = 0.76, sampleOrder = c("Tumor_01769", "PDO_01769", "Tumor_18243", "PDO_18243", "Tumor_HN85", "PDO_HN85", "Tumor_HN142", "PDO_HN142","Tumor_HN143","PDO_HN143","Tumor_RS4548","PDO_RS4548","Tumor_RS5650","PDO_RS5650"), draw_titv = TRUE, removeNonMutated = F, barcodeSrt =45, barcode_mar = 5)
...
PlotOncogenicPathways(maf = Merged_MAF, pathways = "RTK-RAS", showTumorSampleBarcodes = T, removeNonMutated = F)
...
PlotOncogenicPathways(maf = Merged_MAF, pathways = "NOTCH", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "WNT", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "Hippo", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "PI3K", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "MYC", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "Cell_Cycle", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "TP53", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "TGF-Beta", showTumorSampleBarcodes = T, removeNonMutated = F)
PlotOncogenicPathways(maf = Merged_MAF, pathways = "NRF2", showTumorSampleBarcodes = T, removeNonMutated = F)
```
